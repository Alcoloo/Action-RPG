...
//						if(GUI.Button(new Rect(25, 215, 100, 30), "Block"))
//						{
//						}
					}
					//get hit
...
//						rpgCharacterController.animator.SetTrigger("BlockTrigger");
					...
					else if(!rpgCharacterController.isBlocking)
					{
						if(!rpgCharacterController.isBlocking)
						{
							...
							//ATTACK LEFT
							if(rpgCharacterController.weapon != Weapon.ARMED || (rpgCharacterController.weapon == Weapon.ARMED && rpgCharacterController.leftWeapon != 0) && rpgCharacterController.leftWeapon != 7)
							{
							...
							//ATTACK RIGHT
							if(rpgCharacterController.weapon != Weapon.ARMED || (rpgCharacterController.weapon == Weapon.ARMED && rpgCharacterController.rightWeapon != 0))
							{
